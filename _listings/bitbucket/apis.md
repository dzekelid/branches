...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/branches/master/_listings/bitbucket/repositories-username-repo-slug-refs-branches-parameters.md
x-common:
- type: x-developer
