...
- name: Github
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/branches/master/_listings/github/repos-owner-repo-branches-branch-get.md
- name: Github Get Repos Owner Repo Branches Branch
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/branches/master/_listings/github/repos-owner-repo-branches-branch-get-postman.md
x-common:
- type: x-net-library
